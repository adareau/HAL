...
# Form implementation generated from reading ui file 'HAL/gui/main.ui'
#
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(10, 30, 205, 102))
        ...
        self.quickStatsButton = QtWidgets.QPushButton(self.groupBox)
        self.quickStatsButton.setGeometry(QtCore.QRect(290, 40, 61, 41))
        self.quickStatsButton.setObjectName("quickStatsButton")
        self.quickPlotButton = QtWidgets.QPushButton(self.groupBox)
        self.quickPlotButton.setGeometry(QtCore.QRect(220, 40, 61, 41))
        self.quickPlotButton.setObjectName("quickPlotButton")
        self.quickPlotEnableFitBox = QtWidgets.QCheckBox(self.groupBox)
        self.quickPlotEnableFitBox.setGeometry(QtCore.QRect(220, 110, 111, 16))
        self.quickPlotEnableFitBox.setObjectName("quickPlotEnableFitBox")
        self.groupBox_2 = QtWidgets.QGroupBox(self.quickAnalysisTab)
        self.groupBox_2.setGeometry(QtCore.QRect(380, 20, 411, 141))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(10, 30, 205, 93))
        self.formLayoutWidget_2.setObjectName("formLayoutWidget_2")
        self.formLayout_2 = QtWidgets.QFormLayout(self.formLayoutWidget_2)
        self.formLayout_2.setContentsMargins(0, 0, 0, 0)
        self.formLayout_2.setVerticalSpacing(5)
        self.formLayout_2.setObjectName("formLayout_2")
        self.quickPlot2DXToolButton = QtWidgets.QToolButton(self.formLayoutWidget_2)
        self.quickPlot2DXToolButton.setObjectName("quickPlot2DXToolButton")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.quickPlot2DXToolButton)
        self.quickPlot2DXLabel = QtWidgets.QLabel(self.formLayoutWidget_2)
        self.quickPlot2DXLabel.setObjectName("quickPlot2DXLabel")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.quickPlot2DXLabel)
        self.quickPlot2DYToolButton = QtWidgets.QToolButton(self.formLayoutWidget_2)
        self.quickPlot2DYToolButton.setEnabled(True)
        self.quickPlot2DYToolButton.setObjectName("quickPlot2DYToolButton")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.quickPlot2DYToolButton)
        self.quickPlot2DYLabel = QtWidgets.QLabel(self.formLayoutWidget_2)
        self.quickPlot2DYLabel.setObjectName("quickPlot2DYLabel")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.quickPlot2DYLabel)
        self.quickPlot2DZToolButton = QtWidgets.QToolButton(self.formLayoutWidget_2)
        self.quickPlot2DZToolButton.setObjectName("quickPlot2DZToolButton")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.quickPlot2DZToolButton)
        self.quickPlot2DZLabel = QtWidgets.QLabel(self.formLayoutWidget_2)
        self.quickPlot2DZLabel.setObjectName("quickPlot2DZLabel")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.quickPlot2DZLabel)
        self.quickPlot2DButton = QtWidgets.QPushButton(self.groupBox_2)
        self.quickPlot2DButton.setGeometry(QtCore.QRect(220, 40, 61, 41))
        self.quickPlot2DButton.setObjectName("quickPlot2DButton")
        self.quickPlot2DEnableStdBox = QtWidgets.QCheckBox(self.groupBox_2)
        self.quickPlot2DEnableStdBox.setGeometry(QtCore.QRect(220, 100, 181, 16))
        self.quickPlot2DEnableStdBox.setChecked(True)
        self.quickPlot2DEnableStdBox.setObjectName("quickPlot2DEnableStdBox")
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1550, 25))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.quickPlot2DEnableStdBox.setText(_translate("mainWindow", "plot standard dev."))
