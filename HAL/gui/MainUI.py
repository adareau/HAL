...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.horizontalLayout_5.addWidget(self.mainScreen)
        ...
        self.metaDataList.setMaximumSize(QtCore.QSize(240, 100))
        ...
        self.horizontalLayout_5.addLayout(self.metaColumn)
        self.screenColumn.addLayout(self.horizontalLayout_5)
        ...
        self.quickPlotEnableFitBox.setGeometry(QtCore.QRect(240, 70, 111, 16))
        ...
        self.horizontalLayout_11 = QtWidgets.QHBoxLayout(self.advancedAnalysisTab)
        self.horizontalLayout_11.setObjectName("horizontalLayout_11")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout()
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.advancedPlotSelectionBox = QtWidgets.QComboBox(self.advancedAnalysisTab)
        ...
        self.advancedPlotSaveButton = QtWidgets.QPushButton(self.advancedAnalysisTab)
        ...
        self.advancedPlotSaveAsButton = QtWidgets.QPushButton(self.advancedAnalysisTab)
        ...
        self.advancedPlotDeleteButton = QtWidgets.QPushButton(self.advancedAnalysisTab)
        ...
        self.horizontalLayout_6.addWidget(self.variableDeclarationTable)
        ...
        self.verticalLayout_6.addWidget(self.subplotSetupTable)
        self.verticalLayout_3 = QtWidgets.QVBoxLayout()
        self.verticalLayout_3.setSpacing(2)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.label_8 = QtWidgets.QLabel(self.advancedAnalysisTab)
        self.label_8.setMaximumSize(QtCore.QSize(40, 16777215))
        self.label_8.setObjectName("label_8")
        self.horizontalLayout_8.addWidget(self.label_8)
        self.updateSubplotLayoutButton = QtWidgets.QPushButton(self.advancedAnalysisTab)
        ...
        self.resetSubplotLayoutButton = QtWidgets.QPushButton(self.advancedAnalysisTab)
        ...
        self.advancedPlotResetButton = QtWidgets.QPushButton(self.advancedAnalysisTab)
        ...
        self.verticalLayout_5.addWidget(self.subplotContentTable)
        ...
        self.verticalLayout_8.addWidget(self.exportToMatplotlibButton)
        self.exportDataButton = QtWidgets.QPushButton(self.advancedAnalysisTab)
        self.exportDataButton.setObjectName("exportDataButton")
        self.verticalLayout_8.addWidget(self.exportDataButton)
        self.advancedStatButton = QtWidgets.QPushButton(self.advancedAnalysisTab)
        self.advancedStatButton.setObjectName("advancedStatButton")
        self.verticalLayout_8.addWidget(self.advancedStatButton)
