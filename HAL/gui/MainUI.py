...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 30, 341, 131))
        ...
        self.gridLayout_5.addWidget(self.quickPlotYToolButton, 1, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.quickPlotFitToolButton, 2, 0, 1, 1)
        self.quickPlotFitLabel = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.quickPlotFitLabel.setObjectName("quickPlotFitLabel")
        self.gridLayout_5.addWidget(self.quickPlotFitLabel, 2, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.quickPlotXToolButton, 0, 0, 1, 1)
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(9, 29, 391, 131))
        ...
        self.quickPlot2DEnableStdBox = QtWidgets.QCheckBox(self.gridLayoutWidget)
        self.quickPlot2DEnableStdBox.setChecked(False)
        self.quickPlot2DEnableStdBox.setObjectName("quickPlot2DEnableStdBox")
        self.gridLayout_4.addWidget(self.quickPlot2DEnableStdBox, 2, 2, 1, 1)
        ...
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(9, 29, 301, 131))
        self.formLayoutWidget_3.setObjectName("formLayoutWidget_3")
        self.formLayout_3 = QtWidgets.QFormLayout(self.formLayoutWidget_3)
        self.formLayout_3.setContentsMargins(0, 0, 0, 0)
        self.formLayout_3.setObjectName("formLayout_3")
        self.correlationsKindToolButton = QtWidgets.QToolButton(self.formLayoutWidget_3)
        self.correlationsKindToolButton.setObjectName("correlationsKindToolButton")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.correlationsKindToolButton)
        self.correlationsKindLabel = QtWidgets.QLabel(self.formLayoutWidget_3)
        self.correlationsKindLabel.setObjectName("correlationsKindLabel")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.correlationsKindLabel)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.correlationsHueCheckBox)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.correlationsKindToolButton.setText(_translate("mainWindow", "kind"))
        self.correlationsKindLabel.setText(_translate("mainWindow", "correlationsKindLabel"))
        self.correlationsHueCheckBox.setText(_translate("mainWindow", "hue by cloud type"))
