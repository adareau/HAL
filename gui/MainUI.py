...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.settingsTabWidget.setGeometry(QtCore.QRect(340, 550, 321, 181))
        self.settingsTabWidget.setObjectName("settingsTabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.dataTypeComboBox = QtWidgets.QComboBox(self.tab)
        self.dataTypeComboBox.setGeometry(QtCore.QRect(10, 10, 111, 23))
